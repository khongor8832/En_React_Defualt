...
function EgovMain(props) {
    ...
    const retrieveList = () => {
        ...
        EgovNet.requestFetch(retrieveListURL,
            ...
            (resp) => {
                ...
                let mutNotiListTag = [];
                mutNotiListTag.push(<li>No Results Found.</li>); // 게시판 목록 초기값
                ...
                mutGallaryListTag.push(<li>No Results Found.</li>); // 게시판 목록 초기값
    ...
    return (
        <div className="container mx-auto P_MAIN">
                ...
                <div className="colbox">
                    ...
                    <div className="right_col">
                        <div className="mini_board">
                            <ul className="tab">
                                <li><Link to={URL.INFORM_NOTICE} className="on">Notice</Link></li>
                                <li><Link to={URL.INFORM_GALLERY}>Gallery</Link></li>
                            </ul>
                            <div className="list">
                                <div className="notice">
                                    <h2 className="blind">Notice</h2>
                                    <ul>
                                        {noticeListTag}
                                    </ul>
                                    <Link to={URL.INFORM_NOTICE} className="more">View more</Link>
                                </div>

                                <div className="gallary">
                                    <h2 className="blind">Gallery</h2>
                                    <ul>
                                        {gallaryListTag}
                                    </ul>
                                    <Link to={URL.INFORM_GALLERY} className="more">View more</Link>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="banner">
                            <Link to={URL.SUPPORT_DOWNLOAD} className="bn1">
                                <strong>Reference Room</strong>
                                <span>Various materials<br/>you can download</span>
                            </Link>
                            <Link to={URL.ABOUT} className="bn2">
                                <strong>Standard Framework Center</strong>
                                <span>Standard framework center <br/> It provides information such as directions.</span>
                            </Link>
                        </div>
                    </div>
                </div>

                <div className="banner_bot bg210">
                    <div className="b1">
                        <div>
                            <h2>주요사업 소개</h2>
                            <p>표준프레임워크가 제공하는<br />
